        ...
        <div class=" max-md:mt-8">
          ...
          <div class="border border-gray-400  rounded-lg p-8 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4">
              <div class="mb-8">
                <h3 class="text-white text-3xl font-semibold">Log in</h3>
                <p class="text-gray-50 text-sm mt-4 leading-relaxed">Glad you’re back.!</p>
              </div>
              ...
              <div>
                <label class="text-gray-50 text-sm mb-2 block">Password</label>
                <div class="relative flex items-center">
                  <input name="password" type="password" required class="w-full  bg-transparent text-sm text-gray-50 border border-gray-300 px-4 py-3 rounded-lg outline-white" placeholder="Password" />
              ...
              <div class="flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" class=" h-4 w-4 shrink-0 text-yellow-600 focus:ring-yellow-500 border-gray-300 rounded" />
                  <label for="remember-me" class="ml-3 block text-sm text-gray-50">
                    Remember me
                  </label>
                </div>
              </div>
              ...
              <div class="text-sm flex justify-center">
                  <a onClick={()=>navigate('/forgot-password')} class="text-white  hover:underline">
              ...
              <button type="button"
                class="border-none outline-none text-white">
